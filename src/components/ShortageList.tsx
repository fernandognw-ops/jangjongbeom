...
export function ShortageList() {
  ...
  return (
    <section className="rounded-xl border border-amber-500/40 bg-amber-500/5 p-4 md:p-5" style={{ backgroundColor: "rgba(245, 158, 11, 0.05)", borderColor: "rgba(245, 158, 11, 0.4)" }}>
      <h2 className="text-sm font-semibold uppercase tracking-wider text-amber-400">
        ⚠ 2주 안전재고 미달
      </h2>
      <p className="mt-1 text-sm text-zinc-300">
        {shortageCount}개 품목이 안전재고 미달입니다. <span className="text-amber-400">데이터 관리</span>에서 상품명별 부족수량을 확인하세요.
      </p>
    </section>
  );
}
